...
import { INTEGRATION_ROUTING_PATHS, INTEGRATIONS_PLUGIN_ID } from '../../../../../../constants';
import {
  useCapabilities,
...
import { RELEASE_BADGE_DESCRIPTION, RELEASE_BADGE_LABEL } from '../../components';
  ...
  return (
    ...
    >
      ...
      {packageInfoError ? (
        ...
        <Switch>
          <Route path={INTEGRATION_ROUTING_PATHS.integration_details_overview}>
            <OverviewPage packageInfo={packageInfo} />
          </Route>
          <Route path={INTEGRATION_ROUTING_PATHS.integration_details_settings}>
            <SettingsPage packageInfo={packageInfo} />
          </Route>
          <Route path={INTEGRATION_ROUTING_PATHS.integration_details_policies}>
            <PackagePoliciesPage name={packageInfo.name} version={packageInfo.version} />
          </Route>
          <Route path={INTEGRATION_ROUTING_PATHS.integration_details_custom}>
            <CustomViewPage packageInfo={packageInfo} />
          </Route>
          <Redirect to={INTEGRATION_ROUTING_PATHS.integration_details_overview} />
        </Switch>
      )}
    </WithHeaderLayout>
  );
